...
function print_template_comments($file = '') {
    if (file_exists(TEMPLATEPATH . '/print-comments.php')) {
        ...
        $file = dirname(__FILE__) . '/print-comments.php';
    }
    return $file;
}
...
function print_can($type) {
    ...
    $print_options = array(
        'comments' => intval($wpmusvn_options['print_options_comments']),
        'links' => intval($wpmusvn_options['print_options_links']),
        'images' => intval($wpmusvn_options['print_options_images']),
        'videos' => intval($wpmusvn_options['print_options_videos'])
    );
