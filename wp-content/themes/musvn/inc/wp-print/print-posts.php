...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?>>
    <head>
        ...
        <?php else: ?>
            <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/inc/wp-print/print-css.css" type="text/css" media="screen, print" />
        <?php endif; ?>
        <?php if ('rtl' == $text_direction): ?>
            ...
            <?php else: ?>
                <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/inc/wp-print/print-css-rtl.css" type="text/css" media="screen, print" />
            <?php endif; ?>
        <?php endif; ?>
        <link rel="canonical" href="<?php the_permalink(); ?>" />
    </head>
    <body>
        <p style="text-align: center;"><strong>- <?php bloginfo('name'); ?> -</strong></p>
        <div class="Center">
            <div id="Outline">
                <?php if (have_posts()): ?>
                    ...
                    <?php if (print_can('links')): ?>
                        <p><?php print_links(); ?></p>
                    <?php endif; ?>
                    <p style="text-align: <?php echo ('rtl' == $text_direction) ? 'left' : 'right'; ?>;" id="print-link"><?php _e('Click', 'wp-print'); ?> <a href="#Print" onclick="window.print();
                            return false;" title="<?php _e('Click here to print.', 'wp-print'); ?>"><?php _e('here', 'wp-print'); ?></a> <?php _e('to print.', 'wp-print'); ?></p>
                    <?php else: ?>
