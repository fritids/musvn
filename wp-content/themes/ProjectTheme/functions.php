...
***************************************************************************/
	...
	DEFINE("PROJECTTHEME_RELEASE", "10 July 2013");
...
function ProjectTheme_send_email_subscription($pid)
{
	...
	$post 	= get_post($pid);
	$s 		= "select distinct cats.uid from ".$wpdb->prefix."project_email_alerts cats, ".$wpdb->prefix."project_email_alerts_locs locs, 
	 			where cats.catid='$cat' AND locs.catid='$loc' AND cats.uid=locs.uid";
